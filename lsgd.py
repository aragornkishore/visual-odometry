...
class LogisticRegression(object):
    ...
    def __init__(self, input, labels, n_in, n_out):
        ...
        self._cost = self.negative_log_likelihood(self.labels)
        self._grads = T.grad(self._cost, self.params)
        self.get_errors = theano.function([self.input,self.labels],self.errors())
        self.get_y_pred = theano.function([self.input],self.y_pred)
    ...
    def errors(self):
        ...
        if self.labels.dtype.startswith('int'):
            ...
            return T.mean(T.neq(self.y_pred, self.labels))
        else:
